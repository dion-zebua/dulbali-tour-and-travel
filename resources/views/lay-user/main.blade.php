  ...
  <body>
    ...
    <main class="main" id="home">
      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-4 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container">
          <a href="/" class="display-2">
            <img src="{{ asset('assets/img/icons/logo2.png') }}" class="logo" alt="logo {{ mine()['longTitle'] }}">
          </a>
          ...
          <div class="collapse navbar-collapse border-top border-2 border-lg-0 border-dark mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base align-items-lg-center align-items-start">
              ...
              <a class="mt-2 mt-lg-0 btn btn-secondary" target="_blank" href="{{ mine()['linkWa']() }}">whatsapp</a>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div class="py-5 text-center">
        <p class="mb-0 text-secondary fs--1 fw-medium">© Copyright <a href="/">{{ mine()['longTitle'] }}</a>  {{ Date('Y') }}</p>
        <p class="mb-0 text-secondary fs--1 fw-medium">Design By <a href="https://www.dion-zebua.my.id" class="text-success">Dion Zebua</a> </p>
      </div>
    </main>
    <!-- ===============================================-->
    <!--    End of Main Content-->
