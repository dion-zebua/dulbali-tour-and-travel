      ...
      <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
          ...
          <div class="d-flex justify-content-center flex-wrap gap-3">
            ...
            <a href="{{ mine()['linkBooking']() }}" target="_blank" class="btn btn-outline-success btn-lg">Booking</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row" id="desc">
        <div class="z-index-1 col-lg-8 mb-5 pe-lg-5">
          <div class="mb-4 text-start">
            <img src="{{ (Storage::exists($package->img)) ? asset('storage/' . $package->img) : asset('storage/upload/package/other.jpg') }}" class="shadow-sm my-img my-2 rounded-1" alt="{{ $package->title }}">
